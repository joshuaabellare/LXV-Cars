...
function rhythm_theme() {
  return array(
    'user_login' => array(
       ...
       'template' => 'rhythm_sub/templates/user/user-login', // set the path here if not in root theme directory
       'render element' => 'form',
    ),
    'user_register_form' => array(
       ...
       'template' => 'rhythm_sub/templates/user/user-register', // set the path here if not in root theme directory
       'render element' => 'form',
    ),
    ...
    'region_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/region/region-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'location_node_form' => array(
      ...
      'template' => 'rhythm_sub/templates/location/location-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'brand_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/brand/brand-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'establishment_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/establishment/establishment-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    ...
    'event_package_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/event package/event-package-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'travel_experience_package_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/travel experience package/travel-experience-package-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'travel_package_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/travel package/travel-package-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'luxury_rental_product_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/luxury rental product/luxury-rental-product-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'marketplace_product_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/marketplace product/marketplace-product-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'professional_page_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/professional page/professional-page-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'article_node_form' => array(
      ...
      'template' => 'rhythm_sub/templates/article/article-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'top_picks_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/top picks/top-picks-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'talent_profile_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/talent profile/talent-profile-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'real_estate_node_form' => array(
      ...
      'template' => 'rhythm_sub/templates/real estate/real-estate-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'real_estate_development_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/real estate development/real-estate-development-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'real_estate_developer_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/real estate developer/real-estate-developer-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'brand_model_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/brand model/brand-model-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'portfolio_node_form' => array(
      ...
      'template' => 'rhythm_sub/templates/portfolio/portfolio-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'event_a_la_carte_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/event a la carte/event-a-la-carte-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'vlog_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/vlog/vlog-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'event_calendar_node_form' => array(
      ...
      'template' => 'rhythm_sub/templates/event calendar/event-calendar-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'business_sale_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/business sale/business-sale-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'vacation_retreat_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/vacation retreat/vacation-retreat-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'car_rental_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/car rental/car-rental-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'yacht_rental_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/yacht rental/yacht-rental-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'aircraft_rental_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/aircraft rental/aircraft-rental-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'event_venue_rental_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/event venue rental/event-venue-rental-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'country_brand_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/country brand/country-brand-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'country_brand_sub_page_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/country brand sub page/country-brand-sub-page-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'brand_sub_page_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/brand sub page/brand-sub-page-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'watch_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/watch/watch-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'service_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/service/service-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    'vehicle_type_node_form' => array(
      'arguments' => array(
        'form' => NULL,
      ),
      'template' => 'rhythm_sub/templates/vehicle type/vehicle-type-node-form', // set the path here if not in root theme directory
      'render element' => 'form',
    ),
    ...
    'dealer_inquiry_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/dealer_inquiry_entityform',
    ),
    'seller_request_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/seller_request_entityform',
    ),
    'get_a_quote_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/get_a_quote_entityform',
    ),
    'get_a_quote_car_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/get_a_quote_car_entityform',
    ),
    'test_drive_request_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/test_drive_request_entityform',
    ),
    'request_call_entityform_edit_form' => array (
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/entityform/request_call_entityform',
    ),
    'user_profile_form' => array(
      'arguments' => array('form' => NULL),
      'render element' => 'form',
      'template' => 'rhythm_sub/templates/user/user-profile-edit',
    )
  );
}
...
function rhythm_menu_link__custom_dynamic_theme_function(array $variables) {
  ...
  if($element['#original_link']['depth'] >= 1 && $element['#original_link']['depth'] <= 2) {
    return '<div class="align-center letter-spacing-3 font-alt fw-600">' . $output . "</div>\n";
  }
