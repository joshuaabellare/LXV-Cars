...
<?php else: ?>
	<br>
	<br>
	<h1 class="uppercase letter-spacing-3 align-center no-margin">Location</h1>
	<br>
	<br>
<?php endif; ?>
<ul class="custom-nav-bars nav nav-tabs align-center" role="tablist">
	<li role="presentation" class="active"><a href="#information" aria-controls="information" role="tab" data-toggle="tab">Information</a></li>
	<li role="presentation"><a href="#descriptions" aria-controls="descriptions" role="tab" data-toggle="tab">Description</a></li>
...
<div class="container">
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="information">
			...
			<br>
			<div class="bg-light-grey border-radius-3 padding-15">
				<h3 class="no-margin uppercase">Country</h3>
				<br>
			...
			<br>
			<div class="bg-light-grey border-radius-3 padding-15">
				<h3 class="no-margin uppercase">Region</h3>
				<br>
				<?php print render($form['field_region']); ?>
			</div>
			<br>
		</div>
		...
		<div role="tabpanel" class="tab-pane" id="media">
			...
			<div class="bg-light-grey border-radius-3 padding-15">
				...
				<p class="custom-field-description align-center">
					...
					<br>
					Image size should be: <strong>(550x450)</strong> Upload size is <strong>300 KB</strong> or less.
				</p>
