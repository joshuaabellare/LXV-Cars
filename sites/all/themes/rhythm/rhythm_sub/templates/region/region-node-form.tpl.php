<?php
	global $base_url;
	$seo_admin_role = array_intersect(array('administrator'), array_values($user->roles));
?>
		...
		<div class="row clearfix">
			<div class="col-md-offset-1 col-md-10">
				<div class="left">
					...
					Reference ID: <?php print $page_id; ?> 
				</div>
				<div class="right">
					<a class="btn btn-mod btn-deep-sky-blue btn-small btn-circle uppercase" target = "_blank" href="<?php print $base_url . '/' . $alias; ?>">View Page </a>
				</div>
			</div>
		</div>
	</div>
...
<?php else: ?>
	<br>
	<br>
	<h1 class="uppercase letter-spacing-3 align-center no-margin">Region</h1>
	<br>
	<br>
<?php endif; ?>
<div class="container">
